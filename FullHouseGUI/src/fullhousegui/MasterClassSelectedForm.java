 ...
 * @author Regi
 */
public class MasterClassSelectedForm extends javax.swing.JFrame {

    /**
     * Creates new form SelectedForm
     */
    public MasterClassSelectedForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasterClassSelectedForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MasterClassSelectedForm().setVisible(true);
            }
        });
    }
